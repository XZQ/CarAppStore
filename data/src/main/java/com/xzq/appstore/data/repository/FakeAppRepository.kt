...
class FakeAppRepository(
    ...
    override suspend fun markInstalled(appId: String) {
        ...
        local.saveInstalledApp(
            InstalledApp(appId = detail.appId, packageName = detail.packageName, name = detail.name, versionName = stagedVersion ?: detail.versionName, versionCode = detail.versionCode)
        )
    }
