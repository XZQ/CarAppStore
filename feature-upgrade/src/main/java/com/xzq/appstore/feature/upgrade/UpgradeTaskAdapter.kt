    ...
    inner class TaskViewHolder(
        ...
        fun bind(item: UpgradeTaskViewData) {
            ...
            binding.tvUpgradeTaskSummary.text = when (item.overallStatus) {
                com.xzq.appstore.data.model.TaskOverallStatus.ACTIVE -> binding.root.context.getString(R.string.task_upgrade_summary_active)
                com.xzq.appstore.data.model.TaskOverallStatus.PENDING -> binding.root.context.getString(R.string.task_upgrade_summary_pending)
                com.xzq.appstore.data.model.TaskOverallStatus.FAILED -> binding.root.context.getString(R.string.task_upgrade_summary_failed)
                com.xzq.appstore.data.model.TaskOverallStatus.COMPLETED -> binding.root.context.getString(R.string.task_upgrade_summary_completed)
            }
