...
import com.xzq.appstore.common.ui.FiveActionHandlers
    ...
    private fun observeState() {
        observeCenterState(viewModel.uiState) { state ->
            ...
            bindWeakNetPanel(
                ...
                showPanel = state.screenState is DownloadManagerScreenState.Error,
            )
            bindPermissionPanel(
                ...
                showPanel = state.readyInstallCount > 0 && !canRequestPackageInstalls(),
