...
import com.xzq.appstore.feature.home.databinding.ItemAppCardBinding
...
class HomeAdapter(
    ...
    class HomeViewHolder(
        ...
        fun bind(item: AppViewData) {
            binding.tvAppInitial.text = item.iconText.ifBlank { item.name.firstOrNull()?.toString().orEmpty() }
